 ...
 */
namespace PingEntries {
    namespace inaDeploy_rateGroup1 {enum { WARN = 3, FATAL = 5 };}
    namespace inaDeploy_rateGroup2 {enum { WARN = 3, FATAL = 5 };}
    namespace inaDeploy_rateGroup3 {enum { WARN = 3, FATAL = 5 };}
    namespace inaDeploy_cmdSeq {enum { WARN = 3, FATAL = 5 };}
}  // namespace PingEntries
