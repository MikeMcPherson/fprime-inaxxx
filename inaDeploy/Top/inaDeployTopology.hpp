// ======================================================================
// \title  inaDeployTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef INADEPLOY_INADEPLOYTOPOLOGY_HPP
#define INADEPLOY_INADEPLOYTOPOLOGY_HPP
// Included for access to inaDeploy::TopologyState and inaDeploy::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <inaDeploy/Top/inaDeployTopologyDefs.hpp>

// Remove unnecessary inaDeploy:: qualifications
 ...
 * inaDeploy::TopologyState see: inaDeployTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type inaDeploy::TopologyState see: inaDeployTopologyDefs.hpp.
 *
