...
#include <inaDeploy/Top/inaDeployTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    inaDeploy::TopologyState inputs;
    ...
    inaDeploy::setupTopology(inputs);
    inaDeploy::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    inaDeploy::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
